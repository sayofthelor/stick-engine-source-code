...
class MainMenuState extends MusicBeatState
{
	...
	public static var loreEngineVersion:String = '1.0';
	public static var psychEngineVersion:String = '1.0'; // to maximize compatibility
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, (ClientPrefs.showLore ? "Stick Engine v" + (loreEngineVersion.endsWith(".0") ? loreEngineVersion.replace(".0", "") + " \\ " : loreEngineVersion + " \\ ") : "") + "Friday Night Funkin' v" + Application.current.meta.get('version')#if debug + " (debug)"#end, 12);
		versionShit.scrollFactor.set();
		if (menuJson.overrideVersionText && menuJson.customVersionText != "") versionShit.text = menuJson.customVersionText;
		versionShit.screenCenter(X);
		versionShit.setFormat("assets/fonts/PhantomMuff.ttf", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
