...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		installButton.label.setFormat(Paths.font("PhantomMuff.ttf"), 16, FlxColor.WHITE, CENTER);
		...
		removeButton.label.setFormat(Paths.font("PhantomMuff.ttf"), 16, FlxColor.WHITE, CENTER);
